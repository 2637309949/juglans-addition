  ...
  (function () {
    ...
    var ca = function () {
      ...
      (function () {
        ...
        function A(a) {
          for (var d = void 0, f = a.firstChild; f; f = f.nextSibling) var b = f.nodeType, d = 1 === b ? d ? a : f : 3 === b ? T.test(f.nodeValue) ? a : d : d;
        ...
        function B(a, d, f) {
          function b(a) {
            ...
            if (1 == c && !k.test(a.className)) {
              if ("br" === a.nodeName) g(a), a.parentNode && a.parentNode.removeChild(a);else for (a = a.firstChild; a; a = a.nextSibling) b(a);
            } else if ((3 == c || 4 == c) && f) {
              var d = a.nodeValue,
                  p = d.match(q);
