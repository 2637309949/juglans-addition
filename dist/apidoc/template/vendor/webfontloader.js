...
(function () {
  ...
  function w(a, b, d) {
    ...
    for (var c = a.className.split(/\s+/), e = 0; e < b.length; e += 1) {
      for (var f = !1, g = 0; g < c.length; g += 1) if (b[e] === c[g]) {
        f = !0;
        break;
      }
    ...
    for (e = 0; e < c.length; e += 1) {
      ...
      for (g = 0; g < d.length; g += 1) if (c[e] === d[g]) {
        f = !0;
        break;
      }
  ...
  function L(a, b, d) {
    if (a.j && a.h[b]) if (d) a.h[b](d.c, K(d));else a.h[b]();
  }
  ...
  ua.prototype.load = function (a) {
    ...
    for (d = e.length; b < d; b++) if (c = e[b].split(":"), c[1]) for (var h = c[1].split(","), m = 0; m < h.length; m += 1) k.push(new H(c[0], h[m]));else k.push(new H(c[0]));
  ...
  Ha.prototype.load = function (a) {
    ...
    b ? B(this.c, (this.a.api || "https://use.typekit.net") + "/" + b + ".js", function (b) {
      if (b) a([]);else if (d.Typekit && d.Typekit.config && d.Typekit.config.fn) {
