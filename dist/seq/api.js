...
repo.Api.prototype.Delete = function (router, name) {
  ...
  middles.push(h.R);
  router.delete.apply(router, [opts.routePrefixs.delete(name, this.opts)].concat(middles));
  profile.docs = profile.docs.concat(doc.GenDoc({
    profile,
    opts,
    apis: ['delete']
...
repo.Api.defaultOpts = {
  ...
  routeHooks: {
    ...
    create: {
      ...
      cond: function () {
        var _ref10 = _asyncToGenerator(function* (_cond3, ctx, opts) {
          return _cond3;
        });

        return function cond(_x14, _x15, _x16) {
    ...
    delete: {
      form: function () {
        var _ref11 = _asyncToGenerator(function* (_form2) {
          return _form2;
        });

        return function form(_x17) {
    ...
    update: {
      form: function () {
        var _ref12 = _asyncToGenerator(function* (_form3) {
          return _form3;
        });

        return function form(_x18) {
      ...
      cond: function () {
        ...
        return function cond(_x19, _x20, _x21) {
