...
repo.Api.prototype.Create = function (router, name, ...middles) {
  ...
  middles.push(h.R)
  router.post(opts.routePrefixs.create(name, this.opts), ...middles)
...
repo.Api.prototype.Update = function (router, name, ...middles) {
  ...
  middles.push(h.R)
  router.put(opts.routePrefixs.update(name, this.opts), ...middles)
...
repo.Api.prototype.Delete = function (router, name, ...middles) {
  ...
  middles.push(h.R)
  router.delete(opts.routePrefixs.delete(name, this.opts), ...middles)
...
repo.Api.prototype.ALL = function (router, name, ...middles) {
  ...
  router.get(
    opts.routePrefixs.list(name, opts),
    ...middles,
    async ctx => {
      const optHook = opts.routeHooks.list
      const h1 = hook.Hook({
  ...
  router.delete(
    opts.routePrefixs.delete(name, this.opts),
    ...middles,
    async ctx => {
      const optHook = opts.routeHooks.delete
      const h1 = hook.Hook({
