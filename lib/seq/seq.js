...
// defaultOpts for sequelize
Ext.defaultOpts = { operatorsAliases, paranoid: true }
...
Ext.prototype.Register = function (schema = {}, opts = {}) {
...
// Register model and return model
Ext.prototype.DefineSchema = function (...schema) {
